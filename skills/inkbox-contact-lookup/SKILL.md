...
DeepSeek Harness receives contact context on inbound email, SMS, iMessage, and calls when Inkbox resolves the sender, and it can read or update the organization's shared contacts.
...
- There is no vCard export/import, contact access, or contact rule tool in DeepSeek Harness.
